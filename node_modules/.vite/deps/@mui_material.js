...
var SnackbarContentRoot = styled_default(Paper_default, {
  ...
  const backgroundColor = (0, import_colorManipulator4.emphasize)(theme.palette.background.default, emphasis);
...
var SpeedDialActionFab = styled_default(Fab_default, {
  ...
  backgroundColor: (theme.vars || theme).palette.background.paper,
  "&:hover": {
    backgroundColor: theme.vars ? theme.vars.palette.SpeedDialAction.fabHoverBg : (0, import_colorManipulator5.emphasize)(theme.palette.background.paper, 0.15)
  },
  transition: `${theme.transitions.create("transform", {
